...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_recipe_with_tags(self):
        ...
        tag1 = sample_tag(user=self.user, name='Starter')
    ...
    def test_create_recipe_with_ingredients(self):
        ...
        ing1 = sample_ingredient(user=self.user, name='Pepper')
        ...
        self.assertEqual(ing.count(), 2)
        self.assertIn(ing1, ing)
        self.assertIn(ing2, ing)

    def test_partial_recipe_update(self):
        """Test update a recipe with path"""
        recipe = sample_recipe(user=self.user)
        recipe.tags.add(sample_tag(user=self.user))
    ...
    def test_full_recipe_update(self):
        """Test full recipe update with path"""
        recipe = sample_recipe(user=self.user)
        recipe.tags.add(sample_tag(user=self.user))
        payload = {
            'title': 'Spaghetti',
